  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: Colors
                .grey[800]!), // Adjust the border color to match your theme
      ),
      child: Column(
        ...
        children: [
          Text(label,
              style: TextStyle(
                  color: Color.fromRGBO(187, 205, 255, 100), fontSize: 16.0)),
          Row(
            children: [
              Text(value,
...
Widget buildHealth(BuildContext context) {
  return Column(
    ...
    children: [
      ...
      EcosystemItem(label: 'Fully Diluted Valuation', value: '\$4,138,862,797'),
